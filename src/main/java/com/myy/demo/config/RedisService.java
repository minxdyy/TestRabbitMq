...
public class RedisService {
    ...
    @SuppressWarnings("unchecked")
    public void gqSet(String key, Object hashKey, Object value,long time) {
        HashOperations<String, Object, Object> hash = redisTemplate.opsForHash();
    ...
    public Long increment(String key,long data) {
        ValueOperations<Serializable, Object> operations = redisTemplate.opsForValue();
        Long increment = operations.increment(key, data);
        return increment;
    }
    public Set<String> fields(String key){
        HashOperations<String, String, Object> hash = redisTemplate.opsForHash();
        Set<String> fields = hash.keys(key);
        return fields;
    }
    public Map<String,String> entry(String key){
